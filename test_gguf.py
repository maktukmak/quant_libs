...
def run_gguf_inference(model_path):
    ...
    qlinear  = llm.llm_engine.model_executor.driver_worker.model_runner.model.model.layers[0].self_attn.o_proj

    print('In_features:', qlinear.input_size)
    print('Out_features:', qlinear.output_size)
    print('Weight shape:', qlinear.qweight.shape)
    print('Storage data-type:', qlinear.qweight.dtype)
